...
Copy-Item $INDEX_FILE "$INDEX_FILE.bak"

# index.html にリンクリストを自動追加
$INDEX_CONTENT = Get-Content $INDEX_FILE -Raw
$UPDATED_CONTENT = $INDEX_CONTENT -replace '(<!-- AUTOGENERATED LINKS START -->.*<!-- AUTOGENERATED LINKS END -->)', ''
$UPDATED_CONTENT = $UPDATED_CONTENT -replace '<ul>', "<ul>`n<!-- AUTOGENERATED LINKS START -->`n$LINKS<!-- AUTOGENERATED LINKS END -->"
